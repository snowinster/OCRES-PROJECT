...
class ConvertSet extends Component {
  constructor(props) {
    super(props);
    this.state = {
      convert: null,
  ...
  callAPI() {
    ...
    myHeaders.append("apikey", "yE0vtadipeqVRoWDADW2knPj5wMGZCI2"); // val vHw5dS5414gNvB3WyclPZypNqKm7t9b5 //AJO9SAiHwYd3R2fk0zsdm9WOeaSLBXIx //GUFJMb9UK8uY4zWiAz5AV1TNxnzLZnzz //RXkbN1uuhUrnN9bhEPrEj7smnpwFb5kJ
    ...
    return (
      ...
      <div>
        ...
        <div id="ConvertOne">
          ...
          <p id="Convertt">conversion : {convert}</p>
        </div>
